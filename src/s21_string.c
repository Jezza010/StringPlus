...
/*Func 1: Searches for the first occurrence of the character c (an unsigned
...
/*Func 2: Compares the first n bytes of str1 and str2.*/
...
/*Func 3: Copies n characters from src to dest.*/
...
/*Func 4: Copies the character c (an unsigned char) to the first n characters of
...
/*Func 5: Appends the string pointed to, by src to the end of the string pointed
...
/*Func 6: Searches for the first occurrence of the character c (an unsigned
...
/*Func 7: Compares at most the first n bytes of str1 and str2.*/
...
/*Func 8: Copies up to n characters from the string pointed to, by src to
 * dest.*/
...
/*Func 9: Calculates the length of the initial segment of str1 which consists
...
/*Func 10: Searches an internal array for the error number errnum and returns a
pointer to an error message string. You need to declare macros containing arrays
of error messages for mac and linux operating systems. Error descriptions are
available in the original library. Checking the current OS is carried out using
directives.*/
...
/*Func 11: Computes the length of the string str up to but not including the
terminating s21_null character.*/
...
/*Func 12: Finds the first character in the string str1 that matches any
...
/*Func 13: Searches for the last occurrence of the character c (an unsigned
char) in the string pointed to by the argument str.*/
...
/*Func 14: Finds the first occurrence of the entire string needle (not including
the terminating s21_null character) which appears in the string haystack.*/
...
/*Func 15: Breaks string str into a series of tokens separated by delim.*/
...
/*Bonus 1: Returns a copy of string (str) converted to uppercase. In case of any
 error, return NULL. */
...
/*Bonus 2: Returns a copy of string (str) converted to lowercase. In case of any
 error, return NULL.*/
...
/*Bonus 3: Returns a new string in which a specified string (str) is inserted at
...
/*Bonus 4: Returns a new string in which all leading and trailing occurrences of
...
/*supplementary for sprintf: copy a block of memory from one location to another
...
/*supp for sprintf: compares the string pointed to by s1 to the string pointed
 to by s2.*/
